...
### [5] [S3Mem: Structured Spatiotemporal Scene-Event Memory for Long-Horizon Interactive Question Answering](https://arxiv.org/abs/2605.28831)
...
### [6] [A comparative study of transformer-based embeddings for topic coherence](https://arxiv.org/abs/2605.28832)
...
### [10] [From Data to Insights: Exploring Program-of-Thoughts Prompting for Chart Summarization](https://arxiv.org/abs/2605.28874)
*Yutong Qu,Wei Zhang*
...
### [11] [Reasoning that Travels: Dissecting How Chain-of-Thought Transfers Across Models](https://arxiv.org/abs/2605.28913)
...
### [12] [The Trust Paradox: How CS Researchers Engage LLM Leaderboards](https://arxiv.org/abs/2605.28966)
...
### [13] [Error as a Lens: Probing LLM Reasoning through Synthetic Misconception Generation](https://arxiv.org/abs/2605.29007)
*Xinming Yang,Jun Li*
...
### [14] [LLMBridge: An LLM Pipeline for End-to-end Referential Bridging Resolution in English](https://arxiv.org/abs/2605.29048)
...
### [16] [Same Question, Different Source, Different Answer: Auditing Source-Dependence in Medical Multi-Source RAG](https://arxiv.org/abs/2605.29084)
...
### [17] [SafeRx-Agent: A Knowledge-Grounded Multi-Agent Framework for Safe and Explainable Medication Recommendation](https://arxiv.org/abs/2605.29146)
...
### [18] [Slogans or Stance? A Label-Light Diagnostic for Entrepreneurial-Discourse Measurement on Chinese SOE Speeches](https://arxiv.org/abs/2605.29188)
...
### [20] [Learnable Assessment Skills for LLM-based Automated Scoring: Rubric Construction via Iterative Optimization](https://arxiv.org/abs/2605.29274)
...
### [21] [Prompt-Level Reward Specifications for Open-Ended Post-Training](https://arxiv.org/abs/2605.29275)
...
### [22] [MusTBENCH: Benchmarking and Advancing Temporal Grounding in Music LLMs](https://arxiv.org/abs/2605.29300)
...
### [23] [GrepSeek: Training Search Agents for Direct Corpus Interaction](https://arxiv.org/abs/2605.29307)
...
### [24] [Rethinking Stepwise Model Routing: A Cost-Efficient Table Reasoning Perspective](https://arxiv.org/abs/2605.29319)
...
### [25] [A Study on Question-Answer Dataset for LLM Safety Evaluation with a Focus on Illegal Activities](https://arxiv.org/abs/2605.29340)
...
### [26] [Draft-OPD: On-Policy Distillation for Speculative Draft Models](https://arxiv.org/abs/2605.29343)
...
### [27] [Attention Asymmetry in AI Layoff Discourse on X: A Computational Analysis of Capital vs Labour Amplification](https://arxiv.org/abs/2605.29367)
*Joy Bose*
...
### [28] [SURGENT: A Surgical Multi-Agent Assistance System Across the Perioperative Workflow](https://arxiv.org/abs/2605.29368)
...
### [29] [Beyond Bilingual Transfer: Multilingual Code-Switching in Instruction Tuning](https://arxiv.org/abs/2605.29414)
...
### [30] [Learning Design Skills as Memory Policies for Agentic Photonic Inverse Design](https://arxiv.org/abs/2605.29421)
...
### [31] [SkillBrew: Multi-Objective Curation of Skill Banks for LLM Agents](https://arxiv.org/abs/2605.29440)
...
### [32] [Comparative Evaluation of Machine Translation Systems on Images with Text](https://arxiv.org/abs/2605.29476)
...
### [33] [PhoneWorld: Scaling Phone-Use Agent Environments](https://arxiv.org/abs/2605.29486)
...
### [34] [Mask the Target: A Plug-and-Play Regularizer Against LoRA Forgetting](https://arxiv.org/abs/2605.29498)
...
### [35] [Source-Grounded Semantic Reinforcement Learning for Low-Resource Target-Language Generation](https://arxiv.org/abs/2605.29502)
...
### [38] [Entity-Collision: A Stratified Protocol for Attributing Retrieval Lift in Agent Memory](https://arxiv.org/abs/2605.29630)
*Youwang Deng*
...
### [39] [Predicting Causal Effects from Natural Language Queries using Structured Representations](https://arxiv.org/abs/2605.29631)
...
### [40] [Classification of non-analyzable word types in web documents to implement an effective Korean e-learning system](https://arxiv.org/abs/2605.29638)
...
### [41] [Verifiable Rewards Beyond Math and Code: Lightweight Corpus-Grounded Process Supervision for Factual Question Answering](https://arxiv.org/abs/2605.29648)
...
### [42] [EviLink: Multi-Path Schema Linking with Uncertainty-Guided Evidence Acquisition for Large-Scale Text-to-SQL](https://arxiv.org/abs/2605.29670)
...
### [43] [Spurious Prompts: Can Irrelevant Prompts Steer Large Language Models?](https://arxiv.org/abs/2605.29678)
...
### [44] [Domino: Decoupling Causal Modeling from Autoregressive Drafting in Speculative Decoding](https://arxiv.org/abs/2605.29707)
...
### [46] [Teaching Language Models to Check Grounded Claim Factuality with Human Test-Taking Strategies](https://arxiv.org/abs/2605.29712)
...
### [47] [User-Aware Active Knowledge Acquisition for Emotional Support Dialogue](https://arxiv.org/abs/2605.29715)
...
### [48] [HTAM: Hierarchical Transition-Attended Memory for Operator Optimization](https://arxiv.org/abs/2605.29734)
...
### [49] [AfriScience-MT: Towards Decolonizing Science in Africa through Text Translation](https://arxiv.org/abs/2605.29741)
...
### [50] [DySem: Uncovering Dynamic Semantic Components via Multilingual Consensus for Calculating Semantic Textual Similarity](https://arxiv.org/abs/2605.29751)
...
### [51] [Metric-Dependent Annotation Saturation for Learning from Label Distributions](https://arxiv.org/abs/2605.29797)
*Guneet Kohli*
...
### [55] [CRITIC-R1: Learning Structured Critics for Retrieval-Augmented Generation](https://arxiv.org/abs/2605.29886)
...
### [56] [Internal Representation, Not Clinical Knowledge: Where Apparent LLM Triage Failures Originate](https://arxiv.org/abs/2605.29889)
...
### [57] [Does The Way You Plan Matter? An Empirical Study of Planning Representations for LLM Web Agents](https://arxiv.org/abs/2605.29927)
...
### [58] [Latent Performance Profiling of Large Language Models](https://arxiv.org/abs/2605.30018)
...
### [59] [Recovering Diversity Without Losing Alignment: A DPO Recipe for Post-Trained LLMs](https://arxiv.org/abs/2605.30021)
...
### [60] [Who Am I? History-Aware Profiles for Student Simulation in Tutoring Dialogues](https://arxiv.org/abs/2605.30051)
...
### [61] [UniSteer: Text-Guided Flow Matching in Activation Space for Versatile LLM Steering](https://arxiv.org/abs/2605.30076)
...
### [62] [Adaptive Targeted Dynamic Chunking for Tokenization-Free Hierarchical Model](https://arxiv.org/abs/2605.30080)
...
### [63] [SEAL: Can Saturated Benchmarks Be Revived by LLM-as-a-Meta-Judge?](https://arxiv.org/abs/2605.30104)
...
### [64] [CorPipe at CRAC 2026: Empty Nodes and Cross-Lingual Transfer in Multilingual Coreference Resolution](https://arxiv.org/abs/2605.30133)
*Milan Straka*
...
### [65] [GRUFF: LLM Pronoun Fidelity, Reasoning, and Biases in German](https://arxiv.org/abs/2605.30214)
...
### [66] [Do Language Models Track Entities Across State Changes?](https://arxiv.org/abs/2605.30233)
...
### [67] [Knowing What to Solve Before How: Preplan Empowered LLM Mathematical Reasoning](https://arxiv.org/abs/2605.30245)
...
### [68] [How LoRA Remembers? A Parametric Memory Law for LLM Finetuning](https://arxiv.org/abs/2605.30260)
...
### [69] [Loong: A Human-Like Long Document Translation Agent with Observe-and-Act Adaptive Context Selection](https://arxiv.org/abs/2605.30274)
...
### [70] [Resolution Diagnostics for Paired LLM Evaluation](https://arxiv.org/abs/2605.30315)
*Anany Kotawala*
...
### [71] [Unlocking the Working Memory of Large Language Models for Latent Reasoning](https://arxiv.org/abs/2605.30343)
